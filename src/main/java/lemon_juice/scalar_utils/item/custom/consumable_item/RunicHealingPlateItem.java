...
public class RunicHealingPlateItem extends Item  {

    public RunicHealingPlateItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        components.add(Component.translatable("tooltip.scalar_utils.runic_healing_plate"));
    }
}
